 ...
 * 
 */
public class LogBatchMonitorAgent implements IBatchExecutionMonitorAgent {

	private static final long DEFAULT_WRITING_DELAY = 5000;

	private static Logger logger = LoggerFactory
			.getLogger(LogBatchMonitorAgent.class);
	...
	private IBatchExecutionMonitorAgent parent;
	 ...
	 *            job execution id
	 */
	public LogBatchMonitorAgent(String executionId) {
	 ...
	 */
	private LogBatchMonitorAgent(String executionId,
			IBatchExecutionMonitorAgent parent, int parentWork) {
		this.executionId = executionId;
		this.parent = parent;
	...
	public IBatchExecutionMonitorAgent createSubTask(int work) {
		return new LogBatchMonitorAgent(executionId, this, work);
	}
