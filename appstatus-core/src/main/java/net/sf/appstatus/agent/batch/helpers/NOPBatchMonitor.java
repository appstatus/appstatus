 ...
 * 
 */
public class NOPBatchMonitor implements IBatchMonitor {

	/**
	 * The unique instance of NOPJobProgressAgentMonitor.
	 */
	public static final NOPBatchMonitor NOP_BATCH_MONITOR = new NOPBatchMonitor();
