...
/**
 * A direct NOP (no operation) implementation of {@link IServiceMonitor}.
 * 
 * @author Guillaume Mary
 * 
 */
public class NOPServiceMonitor implements IServiceMonitor {

	/**
	 * The unique instance of NOPServiceAgentMonitor.
	 */
	public static final NOPServiceMonitor NOP_SERVICE_AGENT_MONITOR = new NOPServiceMonitor();
