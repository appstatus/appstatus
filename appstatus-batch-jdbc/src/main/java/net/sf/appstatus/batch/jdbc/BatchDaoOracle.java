	...
	protected String getSql(int query) {
		...
		case BATCH_FETCH:
			return "SELECT " //
					...
					+ "FROM ( " //
					 + "SELECT UUID_BATCH, ITEM, CURRENT_TASK, END_DATE, GROUP_BATCH, ITEMCOUNT, LAST_MSG, UPDATED, NAME_BATCH, PROGRESS, REJECT, START_DATE, STATUS,SUCCESS, ROWNUM r FROM "
