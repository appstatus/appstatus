 ...
 * {@link IJobProgressAgentMonitor}.
 * 
 * @author Guillaume Mary
 * 
 */
public class NOPJobProgressAgentMonitor implements IJobProgressAgentMonitor {

	/**
	 * The unique instance of NOPJobProgressAgentMonitor.
	 */
	public static final NOPJobProgressAgentMonitor NOP_JOB_PROGRESS_AGENT_MONITOR = new NOPJobProgressAgentMonitor();
	 ...
	 */
	protected NOPJobProgressAgentMonitor() {
	}
