...
/**
 * A direct NOP (no operation) implementation of {@link IServiceStatisticsMonitorAgent}.
 * 
 * @author Guillaume Mary
 * 
 */
public class NOPServiceStatisticsMonitorAgent implements IServiceStatisticsMonitorAgent {

	/**
	 * The unique instance of NOPServiceAgent.
	 */
	public static final NOPServiceStatisticsMonitorAgent NOP_SERVICE_AGENT = new NOPServiceStatisticsMonitorAgent();
	 ...
	 * constructor.
	 */
	protected NOPServiceStatisticsMonitorAgent() {
	}
