...
public class ScenarioOracleCurentLongTest {

    @Autowired
    AppStatus appStatus;

    private final Logger logger = LoggerFactory.getLogger(ScenarioOracleCurentLongTest.class);
