 ...
 * 
 */
public class MemJobProgressAgent extends Observable implements
		IJobProgressAgent, Serializable {
	...
	private static Logger logger = LoggerFactory
			.getLogger(MemJobProgressAgent.class);
	...
	private MemJobProgressAgent parent;
	...
	private final List<MemJobProgressAgent> subTasks = new ArrayList<MemJobProgressAgent>();
	 ...
	 *            job execution id
	 */
	public MemJobProgressAgent(String executionId) {
	 ...
	 */
	private MemJobProgressAgent(String executionId, MemJobProgressAgent parent,
			int parentWork) {
		this.executionId = executionId;
		this.parent = parent;
	...
	public void beginTask(String name, String group, String description,
		...
		if (this.parent == null) {
			this.addObserver(JobProgressAgentMonitorFactory.getMonitor(name));
		}
		setChanged();
	...
	public IJobProgressAgent createSubTask(int work) {
		MemJobProgressAgent subTask = new MemJobProgressAgent(executionId,
				this, work);
	...
	public MemJobProgressAgent getParent() {
		return parent;
	}
	...
	public List<MemJobProgressAgent> getSubTasks() {
		return subTasks;
	}
