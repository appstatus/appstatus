...
public class StaticJobProgressAgentFactoryBinder implements
	...
	private static final String jobProgressMonitorAgentFactoryClassStr = LogJobProgressAgentFactory.class
			.getName();
	
	private final IJobProgressAgentFactory jobProgressMonitorAgentFactory;
	
	private StaticJobProgressAgentFactoryBinder() {
		jobProgressMonitorAgentFactory = new LogJobProgressAgentFactory();
	}
